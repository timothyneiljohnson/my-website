...
export const BANNER_POSTS_API_URL = `${BASE_URL}/wp-json/wp/v2/posts?categories=${BANNER_CATEGORY_ID}&_embed`;
export const FEATURED_POSTS_API_URL = `${BASE_URL}/wp-json/wp/v2/posts?categories=${FEATURED_CATEGORY_ID}&_embed`;
export const AUTHORS_API_URL = `${BASE_URL}/wp-json/wp/v2/users`;
